...
{ 
	...
	// this line is very important: it make sure all the kernel operations are done before returning back to the host CPU; without this line, the result will be random, just as in fds_test_mg.cu
